...
import 'package:ignite_flutter_todo_list/screens/home_controller.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  final _doneItemController = HomeController();
  ...
  void onResetItem(ToDoItem item) {
    _doneItemController.onRemoveItem(item);
    ...
    return Scaffold(
      body: PageView(
        ...
        children: <Widget>[
          ...
          BuilderWidget<ToDoItem>(
            controller: _doneItemController,
            builder: (context, state) {
              return DoneScreen(
                itemList: state,
